...
class LoginLoading extends LoginState {
  LoginLoading(this.body, this.headers, this.extra);
...
class LoginFailed extends LoginState {
  LoginFailed(this.body, this.headers, this.failure, this.extra);
...
class LoginSuccess extends LoginState {
  LoginSuccess(this.body, this.headers, this.data, this.extra);
